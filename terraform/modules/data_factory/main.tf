...
resource "azurerm_resource_group_template_deployment" "pipeline" {
  ...
  parameters_content = jsonencode({
    ...
    fileshareReconcileCurrentFrontierBlobName  = { value = var.adf_fileshare_reconcile_current_frontier_blob_name },
    fileshareReconcileNextFrontierBlobName     = { value = var.adf_fileshare_reconcile_next_frontier_blob_name },
    fileshareReconcileMaxDepth                 = { value = var.adf_fileshare_reconcile_max_depth },
    datalakeReconcileCapBlobName               = { value = var.adf_datalake_reconcile_cap_blob_name },
    datalakeReconcileCurrentFrontierBlobName   = { value = var.adf_datalake_reconcile_current_frontier_blob_name },
    datalakeReconcileNextFrontierBlobName      = { value = var.adf_datalake_reconcile_next_frontier_blob_name },
    datalakeReconcileMaxDepth                  = { value = var.adf_datalake_reconcile_max_depth },
